...
if (jsshell) {
  dump = print;
  dumpln = print;
  printImportant = function(s) { return; dumpln("***"); dumpln(s); }
  ...
  if (navigator.userAgent.indexOf("WebKit") != -1) {
    ...
    dump = function(s) { return; console.log(s); } 
...
var makeStatement = window.fuzzRuderManOrg = function(depth)
{
